      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
          ...
          <div className="flex flex-col justify-end items-start md:items-end">
             <motion.a
               href="https://wa.me/6282227896809"
             ...
             <p className="text-gray-500 text-sm">
               0822-2789-6809 • Admin Tiar Property
             </p>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-12 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-luxury-yellow transition-colors"><Instagram size={20} /></a>
            <a href="#" className="hover:text-luxury-yellow transition-colors"><Facebook size={20} /></a>
            <a href="#" className="hover:text-luxury-yellow transition-colors"><Mail size={20} /></a>
          </div>

          <div className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Tiar Property. All Rights Reserved.
          </div>
        </div>
      </div>
    </footer>
